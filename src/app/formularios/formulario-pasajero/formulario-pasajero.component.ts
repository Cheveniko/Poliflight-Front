...
const NACIONALIDADES: string[] = ['Ecuador', 'Colombia', 'Perú', 'Argentina', 'Chile', 'Brasil', 'España', 'Francia', 'Italia', 'Alemania'];
...
export class FormularioPasajeroComponent {
  ...
  filtrarOpciones(value: string): string[] {
    ...
    return NACIONALIDADES.filter(opcion => opcion.toLowerCase().includes(filtro));
  }
